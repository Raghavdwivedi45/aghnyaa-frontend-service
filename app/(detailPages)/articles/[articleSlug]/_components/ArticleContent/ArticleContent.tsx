...
/* ADD_TAGS above re-permits <iframe> with ANY src, not just YouTube's. Article content is
   author-supplied HTML and reaches us straight from the API, so anyone who can POST an
   article could embed an arbitrary origin in a page served from our domain. Narrow it back
   down: keep YouTube embeds, drop every other iframe. */
